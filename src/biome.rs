    ...
    pub fn new(height: u8, temperature: u8, rainfall: u8, tree_line: u8, ocean_line: u8) -> Biome {
        match height {
            ...
            _ => match (temperature, rainfall) {
                ...
                (t, rf) if t > 165 && rf < 126 => Biome::TropicalDryBroadleafForest,
                (t, rf) if t > 150 && rf < 126 => Biome::TropicalGrassland,
                (t, rf) if t > 155 && rf < 136 => Biome::Woodlands,
                (t, _ ) if t < 100             => Biome::Arctic,
                (t, rf) if t < 120  && rf < 130=> Biome::Tundra,
                (t, _) if t < 135             => Biome::Taiga,
                ...
                (_ ,rf) if rf > 168            => Biome::Wetland,
                (_, rf) if rf > 164            => Biome::FloodedGrassland,
